 ...
 * generated in the my.tz.yaspellmockservice.contract package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: my.tz.yaspellmockservice.contract
     * 
     */
